...
module Apress
  module Variables
    ...
    class Variable < Hash
      ...
      #       :source_class  - Class - класс клсса - источника данных (опционально).
      #       :source_params - Hash - дополнительные параметры источника (опционально).
      #       :source_proc   - Lambda/Proc - выражение для вычисления переменной (опционально).
      #       :type          - Symbol - тип переменной [:integer] (опционально).
